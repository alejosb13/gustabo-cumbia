	...
	<div class="row m-0 pt-4 ">
		...
		<div class="col-md-4 mb-4">
			<div class="padre-disc">
				...
				<div class="wrapper-disc" >
					<div class="icon"></div>
					<span class="texto videos_varios" style="font-weight: 800;margin-top: 10px;display: block;color: #CCA418;font-family: 'Shadows Into Light', cursive !important;text-align: center;font-size: 18px;padding: 0px 20px; cursor: pointer;" >Saludos</span>
				</div>
			</div>
		</div>
	</div>
