	...
	<div class="container">
		<div class="row row-50 flex-md-row-reverse">
			<div class="col-md-6 text-center">
				<div class="box-image-1"><img src="<?php echo base_url(); ?>lib/images/bio-01-468x553.jpg" alt="" width="468" height="276" />
				</div>
			</div>
			<div class="col-md-6">
				<div class="box-about">
	...
	<div class="container">
		<div class="row row-75 flex-lg-row-reverse">
			<div class="col-lg-6 text-center">
				<div class="box-image-2"><img src="<?php echo base_url(); ?>lib/images/single-album-01-428x428.png" alt="" width="428" height="214" />
				</div>
			</div>
			<div class="col-lg-6">
				<h2>Change & Evolve</h2>
							...
							<div class="jp-modern jp-player-init">
								...
								<div class="jp-audio jp-audio-0" role="application" aria-label="media player">
									<ul class="jp-player-list">
										...
										<li class="jp-player-list-item" data-jp-title="ale" data-jp-mp3="<?php echo base_url(); ?>lib/audio/test.mp3"></li>
									</ul>
									...
									<div class="jp-modern-footer">
										...
										<ul class="jp-modern-linklist">
											<li><a href="#"><img src="<?php echo base_url(); ?>lib/images/itunes-21x21.png" alt="" width="21" height="10" /><span>iTunes</span></a></li>
											<li><a href="#"><img src="<?php echo base_url(); ?>lib/images/spotify-19x19.png" alt="" width="19" height="9" /><span>Spotify</span></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="jp-modern jp-player-init">
								...
								<div class="jp-audio jp-audio-3" role="application" aria-label="media player">
									...
									<div class="jp-modern-footer">
										...
										<ul class="jp-modern-linklist">
											<li><a href="#"><img src="<?php echo base_url(); ?>lib/images/itunes-21x21.png" alt="" width="21" height="10" /><span>iTunes</span></a></li>
											<li><a href="#"><img src="<?php echo base_url(); ?>lib/images/spotify-19x19.png" alt="" width="19" height="9" /><span>Spotify
													</span></a></li>
										</ul>
									</div>
								</div>
	...
	<div class="container">
		<div class="row row-50 flex-lg-row-reverse">
			<div class="col-lg-6 text-lg-center">
				<div class="box-image-1"><img src="<?php echo base_url(); ?>lib/images/events-01-553x316.jpg" alt="" width="553" height="158" />
				</div>
			</div>
			<div class="col-lg-6">
...
<?php $this->load->view('ingles/includes/footer_content_view.php'); ?>
